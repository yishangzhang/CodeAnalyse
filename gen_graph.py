...
class GenGraph:
    def __init__(self, file_in, input_format='gdb'):
        ...
        self.g = None
        # create graph obj
        self.g = pydotplus.Dot(graph_type='graph', 
                          graph_name='Created by: yishangzhang (zhangyi2017@cug.edu.cn)', 
                          rankdir='LR', 
                          strict=True,
                         )
        ...
        rawdataname = file_in +"-rawdata"
        self.g.write(rawdataname)
    ...
    def add_nodes_edges(self):
        ...
        for fn in self.parsed_frame_dict:
            ...
            tooltip_str = '{} - {} - {} - {}'.format(frame.file_name, HTML_SEP,
                                            frame.fn_args.replace('\\', '\\\\'), HTML_SEP)
